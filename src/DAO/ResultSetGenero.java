...
// A classe ResultSetGenero realiza a conexão com o banco de dados 
...
//essa exceção 
public class ResultSetGenero extends AbstractTableModel {
    ...
    //metodo construtor 
    public ResultSetGenero() throws SQLException {
        ...
        pstmt = con.prepareStatement("select * from generos");
