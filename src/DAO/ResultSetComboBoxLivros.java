...
public class ResultSetComboBoxLivros extends AbstractListModel implements ComboBoxModel {
    ...
    public ResultSetComboBoxLivros() throws SQLException {
        if (con == null) {//coneta ao BD
            con = new Conexao().getConnection();
        }

        pstmt = con.prepareStatement("select titulo from livros");
