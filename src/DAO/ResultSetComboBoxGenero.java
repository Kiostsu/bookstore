...
public class ResultSetComboBoxGenero extends AbstractListModel implements ComboBoxModel {
    ...
    public ResultSetComboBoxGenero() throws SQLException {
        if (con == null) {//coneta ao BD
            con = new Conexao().getConnection();
        }

        pstmt = con.prepareStatement("select descricao from generos");
